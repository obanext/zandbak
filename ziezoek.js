...
function search(searchTerm) {
    const types = ['book', 'ebook', 'dvdvideo', 'jsonsrc', 'website'];
    ...
    types.forEach(type => {
        const url = type === 'jsonsrc'
            ? `${baseUrl}%20table:jsonsrc&refine=true&output=json&authorization=${apiKey}`
