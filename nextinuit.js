...
function startQRScanner() {
    ...
    const readerWidth = qrReaderElement.clientWidth;
    const readerHeight = qrReaderElement.clientHeight; 
    
  
    const qrboxDimension = Math.min(readerWidth, readerHeight) * 0.9; 
